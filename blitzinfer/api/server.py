...
# Context lengths set to model max or 128K, whichever is lower
AVAILABLE_MODELS: Dict[str, ModelInfo] = {
    ...
    # Qwen3 VL 32B with thinking - vision model (native 32K)
    ...
    # Qwen3 32B FP8 - fast text model (native 40K)
    "qwen3-32b": ModelInfo(
        name="qwen3-32b",
    ...
    # Qwen 2.5 72B - large Qwen model (native 128K)
    ...
    # GLM 4.6V Flash - fast vision (native 8K)
