#!/usr/bin/env python3
"""5-Model Stress Test V2: With MoE state fix.

Models:
1. Qwen/Qwen3-VL-32B-Thinking-FP8 (VL, FP8)
2. Qwen/Qwen3-VL-32B-Instruct (VL, bfloat16)
3. openai/gpt-oss-120b (LLM, MXFP4, MoE)
4. moonshotai/Kimi-VL-A3B-Thinking-2506 (VL, MoE)
5. mistralai/Mistral-Small-3.2-24B-Instruct-2506 (LLM, VL)
...
MODELS = {
    ...
    "qwen-32b": {
        ...
        "max_model_len": 65536,  # 64K (reduced for bfloat16 size)
        "gpu_memory_utilization": 0.95,
        "dtype": "bfloat16",
        "trust_remote_code": True,
    },
...
def main():
    log("=" * 70)
    log("5-MODEL STRESS TEST V2 (with MoE state fix)")
    log("=" * 70)
